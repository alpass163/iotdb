...
nonReserved
    ...
    | CACHE | CALL | CALLED | CASCADE | CATALOG | CATALOGS | CHAIN | CHAR | CHARACTER | CHARSET | CLEAR | CLUSTER | CLUSTERID | COLUMN | COLUMNS | COMMENT | COMMIT | COMMITTED | CONDITION | CONDITIONAL | CONFIGNODES | CONFIGNODE | CONFIGURATION | CONNECTOR | CONSTANT | COPARTITION | COUNT | CURRENT
    ...
    | ELSEIF | EMPTY | ENC | ENCODING | ERROR | EXCLUDING | EXPLAIN | EXTRACTOR
    ...
    | NANOSECOND | NESTED | NEXT | NFC | NFD | NFKC | NFKD | NO | NODEID | NONE | NORMAL | NULLIF | NULLS
    ...
    | QUERIES | QUERY | QUERY_MODE | QUOTES
    ...
    | SHOW | SINK | SIG | SOME | SOURCE | START | STATS | STOP | SUBSCRIPTION | SUBSCRIPTIONS | SUBSET | SUBSTRING | SYSTEM
